...
## [2026-03-22] Task 29 执行中的上下文工具限制

### 问题描述
- 尝试使用 context7 查询 ratatui 文档时返回 `Invalid API key`。

### 影响
- 无法按计划通过 context7 获取 API 片段，只能改用 docs.rs 查询与本地 API 约束验证。

### 备注
- 本任务功能实现未受阻塞，`cargo build -p card-tui` 仍可通过。
